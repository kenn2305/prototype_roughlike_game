class_name Thunder extends BaseForm
...
func physics_update(delta: float) -> void:
	...
	if form_container.form_container[form_container.current_slot_index] == form_container.FORM_TYPE.FIRE:
		_transition_next_state.emit("Fire",{})
	elif form_container.form_container[form_container.current_slot_index] == form_container.FORM_TYPE.NORMAL:
